    ...
    <div>
      <div className="flex justify-between items-center px-6 py-5 bg-gray-50 shadow-lg">
        ...
        <span className="flex gap-8">
          {username && (
            <>
              <a href="/create" className="hover:underline hover:scale-110">
                Create new post
              </a>
              <a
                onClick={logout}
                className="hover:underline hover:scale-110 cursor-pointer"
              >
                Logout
              </a>
            </>
          ...
          {!username && (
            <>
              <a href="/login" className="hover:underline hover:scale-110">
                Login
              </a>
              <a href="/signup" className="hover:underline hover:scale-110">
                SignUp
              </a>
            </>
          )}
